      ...
      once('brebo-europakozijn', '[data-europakozijn-configurator]', context).forEach((root) => {
        ...
        const drawOperation=(left,top,right,bottom,fn)=>{
          ...
          if(fn==='deur'||fn==='draaikiep'){
            // Draai: twee diagonalen vanaf boven- en onderhoek aan de scharnierzijde
            // naar het centrum van de slotzijde. Voorlopig: scharnieren links, slot rechts.
            line(left+inset,top+inset,right-inset,midY);
            line(left+inset,bottom-inset,right-inset,midY);
          }
          if(fn==='draaikiep'){
            // Kiep: aanvullend twee diagonalen vanaf beide onderhoeken
            // naar het centrum van de bovenzijde.
