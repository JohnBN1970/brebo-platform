...
| `docs/architecture/` | `docs/01-enterprise/` of `docs/03-platform/` | in uitvoering | enterprise-kernmodellen en Module Architecture verplaatst; overige Drupal-implementatiedocumenten nog classificeren |
...
## Uitgevoerde migratieslice 6

| Oud pad | Nieuw pad | Controle |
|---|---|---|
| `docs/architecture/brebo-module-architecture-1.0.md` | `docs/03-platform/drupal/architecture/brebo-module-architecture-1.0.md` | dezelfde Git-blob `b4fde6f3e944a32e30e027c792f93cf441ee7be8`; geen inhoudswijziging |

De verplaatsing is uitgevoerd via één Git-treewijziging waarin dezelfde blob op het nieuwe pad is geplaatst en het oude pad is verwijderd. De documentstatus blijft `concept voor architectuurreview`; de migratie verleent geen inhoudelijke goedkeuring.
...
| BREBO Module Architecture 1.0 | `03-platform/drupal/architecture/` | verplaatst |
